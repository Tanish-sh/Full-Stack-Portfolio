...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://tanish-portfolio-backend-code.onrender.com/api/v1/user/login",
      { email, password },
...
export const getUser = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      "https://tanish-portfolio-backend-code.onrender.com/api/v1/user/portfolio/me",
      {
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        "https://tanish-portfolio-backend-code.onrender.com/api/v1/user/password/update",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://tanish-portfolio-backend-code.onrender.com/api/v1/user/me/profile/update",
      data,
      {
        withCredentials: true,
